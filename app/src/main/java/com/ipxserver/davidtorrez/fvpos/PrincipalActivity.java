...
import com.ipxserver.davidtorrez.fvpos.fragments.FragmentMenu;
...
//       inicializarContenido();
        cargarFragmento(getFragmentMenu());
        cargarFragmentoCategoria(getFragmentTabswipe());
...
//    {
//        this.menuList = (ListView) findViewById(R.id.list_menu_tablet);
...
//        navmenu.add(navItem);
//
//        navAdapter = new NavAdapter(menuList.getContext(),navmenu);
...
//    }
    private void cargarFragmento(Fragment fragment) {
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.replace(R.id.menu_tablet, fragment);//reemplazar el id con el del contenedor
        transaction.commit();

    }
    private void cargarFragmentoCategoria(Fragment fragment)
    {
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.replace(R.id.contenedor_categoria,fragment);
        transaction.commit();
    }
